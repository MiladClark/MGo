...
>(({ className, children, ...props }, ref) => (
  <ScrollAreaPrimitive.Root
    ...
    {...props}
  >
    <ScrollAreaPrimitive.Viewport className="mgo-scrollbar h-full w-full rounded-[inherit] [&>div]:!block [&>div]:max-w-full [&>div]:min-w-0">
      {children}
  ...
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      orientation === "vertical" &&
        "h-full w-1.5 border-s border-s-transparent p-px",
